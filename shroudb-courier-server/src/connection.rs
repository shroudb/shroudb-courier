...
use shroudb_courier_protocol::resp3::writer::write_frame;
use shroudb_courier_protocol::serialize::response_to_frame;
...
pub async fn handle_connection(
    ...
    loop {
        ...
        if let Some(ref mut limiter) = rate_limiter
            && !limiter.try_acquire()
        {
            let response = CommandResponse::Error(shroudb_courier_protocol::CommandError::Denied {
